...
function Band({ maxSpeed = 50, minSpeed = 10 }) {
  ...
  const strapTexture = useTexture('/lanyard/lanyard.png');
  ...
  return (
    <>
      <group position={[0, 4, 0]}>
        ...
        <RigidBody position={[0.5, 0, 0]} ref={j1} angularDamping={2} linearDamping={2}><BallCollider args={[0.1]} /></RigidBody>
        <RigidBody position={[1, 0, 0]} ref={j2} angularDamping={2} linearDamping={2}><BallCollider args={[0.1]} /></RigidBody>
        <RigidBody position={[1.5, 0, 0]} ref={j3} angularDamping={2} linearDamping={2}><BallCollider args={[0.1]} /></RigidBody>
      ...
      <mesh ref={band}>
        <meshLineGeometry />
        <meshLineMaterial transparent resolution={[width, height]} useMap map={strapTexture} repeat={[-1, 1]} lineWidth={1} />
      </mesh>
    </>
  );
}